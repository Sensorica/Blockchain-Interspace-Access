 ...
 */
contract SaflokManager {

    event NewSaflokKey(address contractAddress, bytes32 id, bytes32 expiryDate, bytes32 expiryTime, bytes32 room);
 ...
 /**
    ...
    function createSaflokKey(bytes32 _id, 
        ...
        insert(_id, saflok);
        NewSaflokKey(saflok, saflok.id(), saflok.expiryDate(), saflok.expiryTime(), saflok.room());
        return true;
    }
